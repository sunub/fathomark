...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      ...
      className={cn(
        "tw:size-full tw:min-h-0 tw:min-w-0 scroll-fade-b tw:scrollbar-thin tw:scrollbar-gutter-stable tw:overflow-y-auto tw:overscroll-contain tw:contain-content tw:data-autoscrolling:scrollbar-thumb-transparent tw:data-autoscrolling:scrollbar-track-transparent tw:data-pending-scroll:invisible",
        className
      )}
      {...props}
    />
